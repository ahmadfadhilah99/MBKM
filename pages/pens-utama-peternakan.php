              ...
              <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Cluster Peternakan PENS</b></h2>
                            <p>Informasi tentang Cluster Peternakan pada menu PENS.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                          <a href="galeri/pens-galeri.php?page=pensPeternakanA&type=peternakan">
                    ...
                    <div class="col-md-6 mb-4 stretch-card transparent">
                      <div class="card card-tale">
                          <a href="galeri/pens-galeri.php?page=pensPeternakanB&type=peternakan">
                            <div class="card-body image-gallery">
                                <figure>
