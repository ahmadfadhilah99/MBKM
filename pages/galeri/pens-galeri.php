<?php 
  ...
  if (isset($_GET['page'])) {
      // Kakao
    if ($_GET['page'] == 'pensKakaoA') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Kakao' 
        and `menu_cluster`='PENS' and `sub_menu_cluster`='A'");
    } if ($_GET['page'] == 'pensKakaoB') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Kakao' 
        and `menu_cluster`='PENS' and `sub_menu_cluster`='B'");
      
      // Peternakan
    } if ($_GET['page'] == 'pensPeternakanA') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Peternakan' 
        and `menu_cluster`='PENS' and `sub_menu_cluster`='A'");
    } if ($_GET['page'] == 'pensPeternakanB') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Peternakan' 
        and `menu_cluster`='PENS' and `sub_menu_cluster`='B'");
    
      // Stunting
    } if ($_GET['page'] == 'pensStuntingA') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Stunting' 
        and `menu_cluster`='PENS' and `sub_menu_cluster`='A'");
    } if ($_GET['page'] == 'pensStuntingB') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Stunting' 
        and `menu_cluster`='PENS' and `sub_menu_cluster`='B'");
    }
  }
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <?php if (isset($_GET['page'])) {
            ...
            <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Kakao PENS A</b></h2>
                            <p>Informasi tentang Galeri Kakao Menu PENS A.</p>
                            <a href="../pens-utama-kakao.php">kembali</a>
                        </div>
                    </div>
                </div>
            </div>
            <?php } if ($_GET['page'] == 'pensKakaoB') { ?>
                <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Kakao PENS B</b></h2>
                            <p>Informasi tentang Galeri Kakao Menu PENS B.</p>
                            <a href="../pens-utama-kakao.php">kembali</a>
                        </div>
                    </div>
                </div>
            ...
            <!-- Peternakan -->
            <?php } if ($_GET['page'] == 'pensPeternakanA') { ?>
                <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Peternakan PENS A</b></h2>
                            <p>Informasi tentang Galeri Peternakan Menu PENS A.</p>
                            <a href="../pens-utama-peternakan.php">kembali</a>
                        </div>
                    </div>
                </div>
            </div>    
            <?php } if ($_GET['page'] == 'pensPeternakanB') { ?>
                <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Peternakan PENS B</b></h2>
                            <p>Informasi tentang Galeri Peternakan Menu PENS B.</p>
                            <a href="../pens-utama-peternakan.php">kembali</a>
                        </div>
                    </div>
                </div>
            ...
            <!-- Stunting -->
            <?php } if ($_GET['page'] == 'pensStuntingA') { ?>
                <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Stunting PENS A</b></h2>
                            <p>Informasi tentang Galeri Stunting Menu PENS A.</p>
                            <a href="../pens-utama-stunting.php">kembali</a>
                        </div>
                    </div>
                </div>
            </div>    
            <?php } if ($_GET['page'] == 'pensStuntingB') { ?>
                <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Stunting PENS B</b></h2>
                            <p>Informasi tentang Galeri Stunting Menu PENS B.</p>
                            <a href="../pens-utama-stunting.php">kembali</a>
                        </div>
                    </div>
                </div>
