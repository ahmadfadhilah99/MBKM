<?php 
  ...
  if (isset($_GET['page'])) {
      // Kakao
    if ($_GET['page'] == 'ubtKakaoA') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Kakao' 
        and `menu_cluster`='UBT' and `sub_menu_cluster`='A'");
    } if ($_GET['page'] == 'ubtKakaoB') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Kakao' 
        and `menu_cluster`='UBT' and `sub_menu_cluster`='B'");
      
      // Perikanan
    } if ($_GET['page'] == 'ubtPerikananA') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Perikanan' 
        and `menu_cluster`='UBT' and `sub_menu_cluster`='A'");
    } if ($_GET['page'] == 'ubtPerikananB') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Perikanan' 
        and `menu_cluster`='UBT' and `sub_menu_cluster`='B'");
    
      // Pendidikan
    } if ($_GET['page'] == 'ubtPendidikanA') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Pendidikan' 
        and `menu_cluster`='UBT' and `sub_menu_cluster`='A'");
    } if ($_GET['page'] == 'ubtPendidikanB') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Pendidikan' 
        and `menu_cluster`='UBT' and `sub_menu_cluster`='B'");
    }
  }
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <?php if (isset($_GET['page'])) {
            ...
            <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Kakao UBT A</b></h2>
                            <p>Informasi tentang Galeri Kakao Menu UBT A.</p>
                            <a href="../ubt-utama-kakao.php">kembali</a>
                        </div>
                    </div>
                </div>
            </div>
            <?php } if ($_GET['page'] == 'ubtKakaoB') { ?>
                <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Kakao UBT B</b></h2>
            ...
            <!-- Perikanan -->
            <?php } if ($_GET['page'] == 'ubtPerikananA') { ?>
                <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Perikanan UBT A</b></h2>
                            <p>Informasi tentang Galeri Perikanan Menu UBT A.</p>
                            <a href="../ubt-utama-perikanan.php">kembali</a>
                        </div>
                    </div>
                </div>
            </div>    
            <?php } if ($_GET['page'] == 'ubtPerikananB') { ?>
                <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Perikanan UBT B</b></h2>
                            <p>Informasi tentang Galeri Perikanan Menu UBT B.</p>
                            <a href="../ubt-utama-perikanan.php">kembali</a>
                        </div>
                    </div>
                </div>
            ...
            <!-- Pendidikan -->
            <?php } if ($_GET['page'] == 'ubtPendidikanA') { ?>
                <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Pendidikan UBT A</b></h2>
                            <p>Informasi tentang Galeri Pendidikan Menu UBT A.</p>
                            <a href="../ubt-utama-pendidikan.php">kembali</a>
                        </div>
                    </div>
                </div>
            </div>    
            <?php } if ($_GET['page'] == 'ubtPendidikanB') { ?>
                <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Pendidikan UBT B</b></h2>
                            <p>Informasi tentang Galeri Pendidikan Menu UBT B.</p>
                            <a href="../ubt-utama-pendidikan.php">kembali</a>
                        </div>
                    </div>
                </div>
