<?php 
  ...
  if (isset($_GET['page'])) {
      // Perikanan
    if ($_GET['page'] == 'unpadPerikananA') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Perikanan' 
        and `menu_cluster`='UNPAD' and `sub_menu_cluster`='A'");
    } if ($_GET['page'] == 'unpadPerikananB') {
        $data = mysqli_query($mysqli, "SELECT * FROM `tbl_cluster` WHERE `type_cluster`='Perikanan' 
        and `menu_cluster`='UNPAD' and `sub_menu_cluster`='B'");
    }
  }
?>
            ...
            <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Perikanan UNPAD A</b></h2>
                            <p>Informasi tentang Galeri Perikanan Menu UNPAD A.</p>
                            <a href="../unpad-utama-perikanan.php">kembali</a>
                        </div>
                    </div>
                </div>
            </div>
            <?php } if ($_GET['page'] == 'unpadPerikananB') { ?>
                <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Galeri Perikanan UNPAD B</b></h2>
                            <p>Informasi tentang Galeri Perikanan Menu UNPAD B.</p>
                            <a href="../unpad-utama-perikanan.php">kembali</a>
                        </div>
                    </div>
                </div>
