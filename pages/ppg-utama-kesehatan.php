              ...
              <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Cluster Kesehatan Poltek Piksi Ganesha</b></h2>
                            <p>Informasi tentang Cluster Kesehatan pada menu Poltek Piksi Ganesha.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                          <a href="galeri/ppg-galeri.php?page=ppgKesehatanA&type=kesehatan">
                    ...
                    <div class="col-md-6 mb-4 stretch-card transparent">
                      <div class="card card-tale">
                          <a href="galeri/ppg-galeri.php?page=ppgKesehatanB&type=kesehatan">
                            <div class="card-body image-gallery">
                                <figure>
