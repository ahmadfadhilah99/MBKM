              ...
              <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Cluster Kakao Poltek Piksi Ganesha</b></h2>
                            <p>Informasi tentang Cluster Kakao pada menu Poltek Piksi Ganesha.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                          <a href="galeri/ppg-galeri.php?page=ppgKakaoA&type=kakao">
                    ...
                    <div class="col-md-6 mb-4 stretch-card transparent">
                      <div class="card card-tale">
                          <a href="galeri/ppg-galeri.php?page=ppgKakaoB&type=kakao">
                            <div class="card-body image-gallery">
                                <figure>
