      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#error" aria-expanded="" aria-controls="error">
                  <i class="icon-head menu-icon"></i>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                          <a href="galeri/ubt-galeri.php?page=ubtKakaoA&type=kakao">
                    ...
                    <div class="col-md-6 mb-4 stretch-card transparent">
                      <div class="card card-tale">
                          <a href="galeri/ubt-galeri.php?page=ubtKakaoB&type=kakao">
                            <div class="card-body image-gallery">
                                <figure>
