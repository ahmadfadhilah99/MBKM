            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="charts">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="ubt-utama.php?type=Perikanan">UBT</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Cluster Kakao PoltekPiksi Ganesha</b></h2>
                            <p>Informasi tentang Cluster Kakao pada menu PoltekPiksi Ganesha.</p>
                        </div>
                    </div>
                </div>
            </div>
