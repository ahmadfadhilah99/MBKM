              ...
              <div class="row">
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            <h2><b>Cluster Perikanan UBT</b></h2>
                            <p>Informasi tentang Cluster Perikanan pada menu UBT.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                          <a href="galeri/ubt-galeri.php?page=ubtPerikananA&type=perikanan">
                    ...
                    <div class="col-md-6 mb-4 stretch-card transparent">
                      <div class="card card-tale">
                          <a href="galeri/ubt-galeri.php?page=ubtPerikananB&type=perikanan">
                            <div class="card-body image-gallery">
                                <figure>
