                ...
                <div class="col-md-12 mb-4 stretch-card transparent ">
                    <div class="card p-3 shadow">
                        <div class="card-body ">
                            ...
                            <p>Informasi tentang Dokumentasi.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                          <a href="galeri/dok-galeri.php?page=dokumentasiA&type=dokumentasi">
                    ...
                    <div class="col-md-6 mb-4 stretch-card transparent">
                      <div class="card card-tale">
                          <a href="galeri/dok-galeri.php?page=dokumentasiB&type=dokumentasi">
                            <div class="card-body image-gallery">
                                <figure>
