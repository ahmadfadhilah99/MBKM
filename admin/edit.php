<?php
    ...
    if (isset($_POST['edit'])) {
        ...
        header("location:cluster-$info.php?pesan=berhasiledit&type=$info");
    }
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                ...
                <?php
                    while ($cluster = mysqli_fetch_array($select)) {
                ?>    
                
                <form class="row g-3" action="edit.php?id=<?= $cluster['id_cluster']?>&type=<?= $cluster['type_cluster']?>" method="POST" enctype="multipart/form-data">
